...
/**
org.fdroid.fdroid.net.ConnectivityMonitorService;onHandleWork(Landroid/content/Intent;)V
*/

    protected void onHandleWork(android.content.Intent p2)
    {
        if ("org.fdroid.fdroid.net.action.CONNECTIVITY_MONITOR".equals(p2.getAction())) {
