...
/**
androidx.work.impl.constraints.trackers.NetworkStateTracker24;onLost(Landroid/net/Network;)V
*/

    public void onLost(android.net.Network p3)
    {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(p3, "network");
        androidx.work.Logger.get().debug(androidx.work.impl.constraints.trackers.NetworkStateTrackerKt.access$getTAG$p(), "Network connection lost");
        androidx.work.impl.constraints.trackers.NetworkStateTracker24 v3_2 = this.this$0;
        v3_2.setState(androidx.work.impl.constraints.trackers.NetworkStateTrackerKt.getActiveNetworkState(androidx.work.impl.constraints.trackers.NetworkStateTracker24.access$getConnectivityManager$p(v3_2)));
        return;
    }
