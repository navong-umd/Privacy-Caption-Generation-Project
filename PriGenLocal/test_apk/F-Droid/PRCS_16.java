...
/**
org.fdroid.fdroid.views.StatusBanner;onReceive(Landroid/content/Context; Landroid/content/Intent;)V
*/

    public void onReceive(android.content.Context p1, android.content.Intent p2)
    {
        org.fdroid.fdroid.views.StatusBanner.-$$Nest$fputnetworkState(this.this$0, org.fdroid.fdroid.net.ConnectivityMonitorService.getNetworkState(p1));
        org.fdroid.fdroid.views.StatusBanner.-$$Nest$msetBannerTextAndVisibility(this.this$0);
        return;
    }
