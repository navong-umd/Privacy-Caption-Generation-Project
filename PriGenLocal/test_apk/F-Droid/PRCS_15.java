...
/**
org.fdroid.fdroid.views.repos.RepoDetailsViewModel;invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
*/
    ...
    public final Object invokeSuspend(Object p4)
    {
        ...
        if (this.label != 0) {
            ...
            kotlin.ResultKt.throwOnFailure(p4);
            org.fdroid.fdroid.work.RepoUpdateWorker.Companion.updateNow(this.this$0.getApplication(), this.$repoId.longValue());
