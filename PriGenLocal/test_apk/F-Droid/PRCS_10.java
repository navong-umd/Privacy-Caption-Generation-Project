...
/**
org.fdroid.fdroid.views.StatusBanner;onAttachedToWindow()V
*/

    protected void onAttachedToWindow()
    {
        super.onAttachedToWindow();
        android.content.SharedPreferences v0_5 = this.getContext();
        this.networkState = org.fdroid.fdroid.net.ConnectivityMonitorService.getNetworkState(v0_5);
        v0_5.registerReceiver(this.onNetworkStateChanged, new android.content.IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
        ...
        this.overDataState = org.fdroid.fdroid.Preferences.get().getOverData();
        this.overWiFiState = org.fdroid.fdroid.Preferences.get().getOverWifi();
        this.preferences.registerOnSharedPreferenceChangeListener(this.dataWifiChangeListener);
        this.setBannerTextAndVisibility();
        return;
    }
