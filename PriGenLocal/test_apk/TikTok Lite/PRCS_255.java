...
class PRCS_255 {
/**
X.0X9;L(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
    ...
    public static android.net.NetworkInfo L(android.net.ConnectivityManager p18)
    {
        try {
            ...
            com.bytedance.helios.statichook.api.ExtraInfo v10_1 = new com.bytedance.helios.statichook.api.ExtraInfo(0, "()Landroid/net/NetworkInfo;", "dzBzEgAjS8/YVFkiQFyGYmPHmplJNuk8lSiKE+yYZZhKd/yGyg==");
...
/**
X.0X9;LB(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
            ...
            if ((X.75K.L()) || (X.5uK.LBL())) {
                if (X.5uL.LB()) {
                    if ((X.5uC.L == null) || ((!X.5uC.L.isConnected()) || (!X.5uC.L.isAvailable()))) {
                        ...
                        if (X.5uL.LBL()) {
                            X.5uL.L("cm_net_info", X.0X9.L(p3).toString(), X.5uC.L.toString());
                        }
                        return X.5uC.L;
                    }
                } else {
...
/**
X.0X9;L(Landroid/content/Context;)Z
*/

    public static boolean L(android.content.Context p2)
    {
        try {
            int v0_4 = X.0X9.LB(((android.net.ConnectivityManager) p2.getSystemService("connectivity")));
        } catch (Exception) {
            return 0;
        }
        if ((v0_4 == 0) || (!v0_4.isAvailable())) {
            return 0;
        } else {
            return 1;
        }
