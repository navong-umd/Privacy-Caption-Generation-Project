...
*/
    ...
    public final boolean L()
    {
        ...
        if (!X.0Ic.LBL()) {
            try {
                boolean v0_8 = ((android.net.ConnectivityManager) this.LC.getSystemService("connectivity"));
            } catch (boolean v0_3) {
                v0_3.printStackTrace();
                return 0;
            }
            if (v0_8) {
                boolean v0_1 = X.0Ic.LB(v0_8);
                if ((!v0_1) || (!v0_1.isConnected())) {
                    return 0;
                } else {
                    return 1;
                }
