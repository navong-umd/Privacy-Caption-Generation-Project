...
class PRCS_379 {
/**
com.ss.mediakit.net.AVMDLMultiNetwork;com_ss_mediakit_net_AVMDLMultiNetwork_android_net_ConnectivityManager_getNetworkCapabilities(Landroid/net/ConnectivityManager; Landroid/net/Network; Ljava/lang/String;)Landroid/net/NetworkCapabilities;
*/

    public static android.net.NetworkCapabilities com_ss_mediakit_net_AVMDLMultiNetwork_android_net_ConnectivityManager_getNetworkCapabilities(android.net.ConnectivityManager p17, android.net.Network p18, String p19)
    {
