...
/**
X.0Un;L(Landroid/content/Context;)Z
*/

    public static boolean L(android.content.Context p2)
    {
        try {
            int v0_4 = ((android.net.ConnectivityManager) p2.getSystemService("connectivity"));
        } catch (Exception) {
            return 0;
        }
        if (v0_4 == 0) {
            ...
            int v0_5 = X.0Un.LB(v0_4);
            if ((v0_5 == 0) || (!v0_5.isConnected())) {
                return 0;
            } else {
                return 1;
            }
