...
class PRCS_236 {
/**
X.12K;L(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
    ...
    public static android.net.NetworkInfo L(android.net.ConnectivityManager p18)
    {
        try {
            ...
            com.bytedance.helios.statichook.api.ExtraInfo v10_1 = new com.bytedance.helios.statichook.api.ExtraInfo(0, "()Landroid/net/NetworkInfo;", "dzBzEgAjS8/YVFkiQFyNY/5Yq25crjjic/r6AKY4E/JMItPVxQ==");
...
/**
X.12K;LB(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
            ...
            if ((X.75K.L()) || (X.5uK.LB().LB)) {
                if (X.5uV.L()) {
                    if ((X.5uC.L == null) || ((!X.5uC.L.isConnected()) || (!X.5uC.L.isAvailable()))) {
                        ...
                        if (X.5uO.L) {
                            X.5uQ.L("cm_net_info", X.12K.L(p3).toString(), X.5uC.L.toString());
                        }
                        return X.5uC.L;
                    }
                } else {
...
/**
X.12K;L(Landroid/content/Context;)Z
*/

    public static boolean L(android.content.Context p2)
    {
        try {
            int v0_5 = X.12K.LB(((android.net.ConnectivityManager) p2.getSystemService("connectivity")));
        } catch (int v0_2) {
