...
class PRCS_44 {
/**
X.0q1;L(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
    ...
    public static android.net.NetworkInfo L(android.net.ConnectivityManager p18)
    {
        try {
            ...
            com.bytedance.helios.statichook.api.ExtraInfo v10_1 = new com.bytedance.helios.statichook.api.ExtraInfo(0, "()Landroid/net/NetworkInfo;", "dzBzEgAjS8/YVFkiQFyCdOGDsU1sWzlzStbG55Xqq2BKrwb1o6k93d/5T6igzlGAsOhKQZM=");
...
/**
X.0q1;LB(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
            ...
            if ((X.75K.L()) || (X.5uK.LBL())) {
                if (X.5uL.LB()) {
                    if ((X.5uC.L == null) || ((!X.5uC.L.isConnected()) || (!X.5uC.L.isAvailable()))) {
                        ...
                        if (X.5uL.LBL()) {
                            X.5uL.L("cm_net_info", X.0q1.L(p3).toString(), X.5uC.L.toString());
                        }
                        return X.5uC.L;
                    }
                } else {
...
/**
X.0q1;L(Landroid/content/Context;)Z
*/
    ...
    public static boolean L(android.content.Context p2)
    {
        if (p2 != null) {
            try {
                int v0_6 = X.0q1.LB(((android.net.ConnectivityManager) p2.getSystemService("connectivity")));
            } catch (int v0_2) {
