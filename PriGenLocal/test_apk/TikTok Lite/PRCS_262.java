...
/**
X.3ve;handleMsg(Landroid/os/Message;)V
*/

    public void handleMsg(android.os.Message p5)
    {
        if (p5.what != 1000) {
            if ((p5.what == 2000) && (X.3ve.LFF)) {
                if ((X.3vZ.LBL()) && (!this.LIII)) {
                    X.3va.L("token_beat_not_poll", this.LI.getString(2131756828), 0);
                }
                if (!this.LFFFF) {
                    X.3va.L("token_beat_not_config", this.LI.getString(2131755902), this.LFFL);
                }
                if ((X.3vZ.L()) && ((!this.LIIII) || (!this.LIIIII))) {
                    X.3va.L("sdk-version-not-add", this.LI.getString(2131758005), 0);
                }
                if (!this.LCC.LBL) {
                    X.3va.L("tt_token_not_call_add_host_list", 0);
                    this.LI.getString(2131758498);
                }
            }
            return;
        } else {
            this.LCCII.removeMessages(1000);
            this.L(0);
            return;
        }
    }
