...
class PRCS_144 {
/**
X.4GM;L(Landroid/net/ConnectivityManager;)Landroid/net/NetworkInfo;
*/
    ...
    public static android.net.NetworkInfo L(android.net.ConnectivityManager p18)
    {
        try {
            ...
            com.bytedance.helios.statichook.api.ExtraInfo v10_1 = new com.bytedance.helios.statichook.api.ExtraInfo(0, "()Landroid/net/NetworkInfo;", "dzBzEhEpEcvSUUUuTBbKc9NnF3kueWo2KOipcJqAySbspStFVr3I2KuwEau+dnqVaHs0PDFS1g==");
            ...
            if ((X.75K.L()) || (X.5uK.LB().LB)) {
                if (X.5uV.L()) {
                    if ((X.5uC.L == null) || ((!X.5uC.L.isConnected()) || (!X.5uC.L.isAvailable()))) {
                        ...
                        if (X.5uO.L) {
                            X.5uQ.L("cm_net_info", X.4GM.L(v3_1).toString(), X.5uC.L.toString());
                        }
                        v0_13 = X.5uC.L;
                    }
                } else {
